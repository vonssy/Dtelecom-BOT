...
[![GitHub Stars](https://img.shields.io/github/stars/vonssy/Dtelecom-BOT.svg)](https://github.com/vonssy/Dtelecom-BOT/stargazers)
...
dTelecom BOT is an automated tool designed to claim daily check-in across multiple accounts. It provides seamless offers robust proxy support for enhanced security and reliability.

**🔗 Get Started:** [Register on dTelecom](https://rewards.dtelecom.org/reward?referral_code=MSIW9MDV)
...
```bash
git clone https://github.com/vonssy/Dtelecom-BOT.git
cd Dtelecom-BOT
```
...
- **Developer:** vonssy
- **Issues:** [GitHub Issues](https://github.com/vonssy/Dtelecom-BOT/issues)
- **Discussions:** [GitHub Discussions](https://github.com/vonssy/Dtelecom-BOT/discussions)
...
*Thank you for using dTelecom BOT! Don't forget to ⭐ star this repository.*
